...
insert into public.activities (title, description, date, images, created_at) values
  ('Mobile clinic at Wang Ka village',
   ...
   date '2026-05-18', '[]'::jsonb, timestamptz '2026-05-18'),
  ('Village health volunteer (VHV) training',
   ...
   date '2026-04-22', '[]'::jsonb, timestamptz '2026-04-22'),
  ('Child health screening at the border shelter',
   ...
   date '2026-03-10', '[]'::jsonb, timestamptz '2026-03-10'),
  ('Malaria prevention campaign along the border',
   ...
   date '2026-02-14', '[]'::jsonb, timestamptz '2026-02-14'),
  ('Flood relief along the Songkalia River',
   ...
   date '2026-01-05', '[]'::jsonb, timestamptz '2026-01-05'),
  ('Opening of the Sangkhla Buri community clinic',
   ...
   date '2025-11-20', '[]'::jsonb, timestamptz '2025-11-20');

insert into public.members (name, role, sort) values
  ('Dr. Somchai Jaidee',       'Foundation Director',          0),
  ('Wipha Chaidan, RN',        'Mobile Unit Nursing Lead',     1),
  ('Apisit Wangka',            'Field Coordinator',            2),
  ('Pimjai Suksan',            'Social Worker',                2),
  ('Jailu Khamsaeng',          'Community Health Volunteer',   3);

insert into public.milestones (year, title, description, sort) values
  ('2015', 'Foundation established',          'A group of volunteer doctors and medical staff came together and ran the first mobile clinic in Wang Ka village.', 0),
  ('2018', 'Service area expanded',           'Expanded operations to cover Nong Lu sub-district and nearby border areas.', 1),
  ('2020', 'COVID-19 response',               'Set up screening points and distributed protective equipment to border communities.', 2),
  ('2023', 'First VHV training cohort',       'Built a network of over 40 village health volunteers across the area.', 3),
  ('2025', 'Permanent community clinic opens', 'Opened the first Sangkhla Buri community clinic, providing ongoing general care.', 4);
